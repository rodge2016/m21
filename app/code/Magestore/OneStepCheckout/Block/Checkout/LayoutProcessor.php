    ...
    public function process($jsLayout)
    {
        if ($this->_helperConfig->isEnabledOneStep()) {
            ...
            if ($this->_helperConfig->isEnableLoginWithAmazon()) {
                ...
                if(isset($jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']['children']['shipping-method']['component'])) {
                    $jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']['children']['shipping-method']['component'] = "Magestore_OneStepCheckout/js/view/integration/pay-with-amazon/shipping/method";
                }
            }
        }
